...
MIN_PROFIT_THRESHOLD = float(os.getenv('MIN_PROFIT_THRESHOLD', 0.0001))
...
# 🎯 核心升级：在 Python 端完美对齐我们在 setPairConfig 中配置的真实物理档位（防范滑点与越界错误）
PAIR_BORROW_TIERS = {
    ...
    7: [500000, 1000000, 2000000],                                 # 0.005, 0.01, 0.02 WBTC (8位精度)
    8: [5000000, 10000000, 20000000],                              # 0.05, 0.1, 0.2 WBTC
    9: [5000000, 10000000, 20000000]                               # 0.05, 0.1, 0.2 WBTC
}

# 🎯 核心升级：自动读取同目录下的 abi.json，无需手动复制数组，保持代码极端整洁
